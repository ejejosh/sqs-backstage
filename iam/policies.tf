data "aws_iam_policy_document" "tiko_nudge" {
  statement {
    ...
    resources = [data.terraform_remote_state.sqs_sns.outputs.queue_arns["${var.environment}-tea"],      data.terraform_remote_state.sqs_sns.outputs.queue_arns["${var.environment}-handle-inbound-message-command"],
  ...
  statement {
    ...
    resources = [data.terraform_remote_state.sqs_sns.outputs.queue_arns["${var.environment}-tea"],      data.terraform_remote_state.sqs_sns.outputs.queue_arns["${var.environment}-tiko-nudge-offer-validations"],
