data "aws_iam_policy_document" "tiko_nudge" {
  \1
    ...
    # Append resources to the existing consumeSqs statement
    
  
  
    # Append resources to the existing publishQueue statement
    
  
  
    # Append resources to the existing publishTopic statement
    
  
  
    # Append resources to the existing s3Put statement
